...
REQUIRED_FILES = {
    ...
    "src/ossp_router/prompt_router.py",
    "src/ossp_router/protocol.py",
    "src/ossp_router/public_runtime.py",
    "src/ossp_router/resources/prompt-router-public.v1.json",
    ...
    "tools/analyze_prompt_router_v1.py",
    "tools/check_runtime.py",
    "tools/evaluate_prompt_router.py",
    "tools/train_prompt_router.py",
